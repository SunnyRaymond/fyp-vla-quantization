...
核对了 [VLA_idea.pdf](../VLA_idea.pdf) 的 **31 个相关文献条目**。其中 24 项进入 numbered reading route（BarrierNet 用明确标注的前身 author-linked preprint）；另补 6 项，形成 30 个条目。OAT 同目录附一份新扩展稿，所以共 31 份 PDF。余下 7 项保留为扩展入口，未声称已下载或完成全文阅读。
