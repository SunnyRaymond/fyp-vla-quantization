...
\section*{RankCal：面向动作条件潜在世界模型规划的反事实影响量化}
\textbf{方法名称：} RankCal (Counterfactual Influence Quantization)
\section*{研究动机}
