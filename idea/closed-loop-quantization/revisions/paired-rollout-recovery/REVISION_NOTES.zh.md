...
[旧 Stage B](../../../../experiment/idea-validation/closed-loop-quantization/frt-ccds/STAGE_B_RESULT.zh.md) 的 fresh-union 相对 Random 改善0.30%、仅1/3 seeds过门，当前 recipe仍是 mechanism_no_go。A/B工程通过、完整12 records/6DEV、9fits完成的记录保留。
