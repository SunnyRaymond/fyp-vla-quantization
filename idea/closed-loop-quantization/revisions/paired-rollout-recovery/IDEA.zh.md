...
2026-09-12。FRT no-go 后的新研究假设。**状态：有条件的 WM quantization 研究方案，尚未运行；不是已认证的新方法。** 旧 FRT 和 `experiment/idea-validation/closed-loop-quantization/frt-ccds` 的结果保留，不重写其 no-go。
