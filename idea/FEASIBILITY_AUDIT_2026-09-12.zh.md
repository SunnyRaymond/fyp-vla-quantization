...
候选目录 `idea/vq-action-geometry/phase0` 与 `idea/closed-loop-quantization/phase0` 在本审计时仍只有 phase-0 retrieval/material，未出现可据以改变上述 compute 结论的完成候选 artifact；本文件不等待或修改它们。
