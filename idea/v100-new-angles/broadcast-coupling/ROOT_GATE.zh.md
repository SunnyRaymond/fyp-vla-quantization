...
独立 [prior复审](../../../experiment/idea-validation/v100-new-angles/new-cut-shortlist/BROADCAST_ROOT_REVIEW.zh.md) 允许一轮。Root接受空间activation coupling与已停止的weight-member/temporal-weight两个切面不同；不接受原审查“非native干预必不可识别”的规则，也不把generic novelty未验证改写成novelty成立。
