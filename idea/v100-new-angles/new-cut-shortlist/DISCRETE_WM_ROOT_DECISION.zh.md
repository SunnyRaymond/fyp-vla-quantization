...
资源与source入口见[独立审查](../../../experiment/idea-validation/v100-new-angles/new-cut-shortlist/DISCRETE_WM_RESOURCE_GATE.zh.md)。后续需要的是先完成可识别设计，再绑定小资产；没有完整WM训练、ROM下载或完整benchmark计划。
