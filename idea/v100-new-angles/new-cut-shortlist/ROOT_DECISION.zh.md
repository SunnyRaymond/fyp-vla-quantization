...
两项都进入总表，原始提案中“不进入candidate表”的建议不采用，因为用户明确要求全部保留与明确结论。原始 [ROUND2_PRIOR_GATE.zh.md](../../../experiment/idea-validation/v100-new-angles/new-cut-shortlist/ROUND2_PRIOR_GATE.zh.md) 不覆盖、不删除。
