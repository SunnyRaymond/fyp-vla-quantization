...
> **Reading-list role**: Foundational companion to [TurboQuant](../14-turboquant/README.md) and its [symmetric-comparison note](../14a-rabitq-turboquant-comparison/README.md)  
...
3. Compare the transform/code/kernel split with [QuaRot](../12a-quarot/README.md), [SpinQuant](../12-spinquant/README.md), [GPTQ](../10a-gptq-optq/README.md), and [TurboQuant](../14-turboquant/README.md).
...
- **Direct comparison**: the later [symmetric-comparison paper](../14a-rabitq-turboquant-comparison/README.md) reports matched `RaBitQ`/`TurboQuant` experiments, but those experiments were not rerun in this reading packet.
