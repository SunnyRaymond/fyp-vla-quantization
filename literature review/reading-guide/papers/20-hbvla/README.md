...
> **建议先修：** [OpenVLA](../01-openvla/README.md)、[BitVLA](../06-bitvla/README.md)、[OPTQ/GPTQ](../10a-gptq-optq/README.md)，以及 `binary quantization`、`Hessian-aware PTQ`、`Haar transform`。  
...
1. 回顾 [OPTQ/GPTQ](../10a-gptq-optq/README.md) 的 `H = 2XX^T` 与 error compensation。
