...
PushT/TwoRoom/OGBench-Cube 的具体设置见 [LeWM](../../wm/wm-wam-quantization-reading-guide/papers/01-leworldmodel/README.md)；Wall/PointMaze 的设置见 [DINO-WM](../../wm/wm-wam-quantization-reading-guide/papers/02-dino-wm/README.md)。LIBERO/RoboTwin 的跨模型使用证据见对应 paper 的实验与已保存官方 README。
...
| [WorldArena 2.0](../../wm/wm-wam-quantization-reading-guide/papers/20-worldarena-2/README.md) 的 interactive RL track | 在 learned environment 中训练的 policy，回真实 simulator/机器人表现 | learned simulator | agent 可能 exploit WM error，不能只在模型自身世界里评成绩 |
...
| [Physics-IQ](../../wm/wm-wam-quantization-reading-guide/papers/22-physics-iq/README.md) | 需要物理原理的真实视频 continuation | 适合 video WM，latent-only model 需合理适配 |
| [WorldScore](../../wm/wm-wam-quantization-reading-guide/papers/21-worldscore/README.md) | camera controllability、quality、dynamics | world generation 重点；不是机器人任务成功率 |
| [WorldArena](../../wm/wm-wam-quantization-reading-guide/papers/19-worldarena/README.md) | 视频质量 + data engine / policy evaluator / planner utility | 新兴 embodied WM 专门评测，比仅视频指标更贴近功能 |
| [WorldArena 2.0](../../wm/wm-wam-quantization-reading-guide/papers/20-worldarena-2/README.md) | 增加 visuotactile、interactive RL、real-robot 多平台 | 新协议，锁定 track 与 scoring revision，不混报 |
