...
| 推荐者提到的线索 | 最吻合的工作 | 用途 |
|---|---|---|
| 约 15M、单 GPU 数小时、Gaussian regularizer、从 pixels 端到端训练 | [01 LeWorldModel](../../wm/wm-wam-quantization-reading-guide/papers/01-leworldmodel/README.md) | 小规模 latent WM 量化与机制验证 |
| 冻结 DINOv2、预测 patch features、PushT / Wall、zero-shot planning | [02 DINO-WM](../../wm/wm-wam-quantization-reading-guide/papers/02-dino-wm/README.md) | 与已有 WM PTQ 对照 |
| Meta、看大量 internet videos、DROID、Franka 机械臂 | [04 V-JEPA 2 / 2-AC](../../wm/wm-wam-quantization-reading-guide/papers/04-v-jepa-2/README.md) | 大规模 video encoder 与 latent robot planning |
| 系统研究何种 encoder / predictor / planner 更好 | [06 JEPA-WMs](../../wm/wm-wam-quantization-reading-guide/papers/06-jepa-wms/README.md) | 更强、公开的 latent planning recipe |

这些均有 Yann LeCun 作者信息。LeWM 的官方仓库是 **lucas-maes/le-wm**；搜索也会返回保留同一 README 的 fork，不能仅凭 README 自称 official 认定来源。V-JEPA 2.1 是独立的新训练 recipe，见 [05](../../wm/wm-wam-quantization-reading-guide/papers/05-v-jepa-2-1/README.md)。
...
| 顺序 | 阅读项 | 本轮要拿到的判断 |
|---|---|---|
| 1 | [LeWM](../../wm/wm-wam-quantization-reading-guide/papers/01-leworldmodel/README.md) + [TwoRoom 独立复现](../../wm/wm-wam-quantization-reading-guide/papers/18-lewm-reproduction/README.md) | 小型实验是否可做，评估协议有什么坑 |
| 2 | [DINO-WM](../../wm/wm-wam-quantization-reading-guide/papers/02-dino-wm/README.md) → [QuantWM](../../wm/wm-wam-quantization-reading-guide/papers/03-quantwm-STAR/README.md) | 现有 latent WM PTQ 已经回答什么 |
| 3 | [QuantWAMs](papers/23-quantwams/README.md) | WAM PTQ 已有 joint saliency、closed-loop calibration 和 mixed precision |
| 4 | [JEPA-WMs](../../wm/wm-wam-quantization-reading-guide/papers/06-jepa-wms/README.md) | DINO-WM 之外更强的 latent planning 对照 |
...
| 工作 | 推荐定位 | 公开资源与主要边界 |
|---|---|---|
| [V-JEPA 2 / 2-AC](../../wm/wm-wam-quantization-reading-guide/papers/04-v-jepa-2/README.md) | 大规模 latent WM | code / weights；真实机器人协议与 LIBERO 不同 |
| [V-JEPA 2.1](../../wm/wm-wam-quantization-reading-guide/papers/05-v-jepa-2-1/README.md) | 更新的 dense video features | 不能只换 encoder 就假设旧 predictor 兼容 |
...
| [DreamerV3](../../wm/wm-wam-quantization-reading-guide/papers/14-dreamerv3/README.md)、[TD-MPC2](../../wm/wm-wam-quantization-reading-guide/papers/15-td-mpc2/README.md) | RL 基础与强 baseline | 成熟开放实现；不是当前全 benchmark 的统一最新冠军 |
| [SANA-WM](../../wm/wm-wam-quantization-reading-guide/papers/16-sana-wm/README.md)、[Matrix-Game 3.0](../../wm/wm-wam-quantization-reading-guide/papers/17-matrix-game-3/README.md) | 视频 WM 的低精度与 streaming | 已有 low-precision 路线；不同于机器人 manipulation WAM |
...
所有 24 项含本地 PDF 与导读，见 [PDF_INVENTORY.md](PDF_INVENTORY.md)。新增四篇 benchmark 为 [WorldArena](../../wm/wm-wam-quantization-reading-guide/papers/19-worldarena/README.md)、[WorldArena 2.0](../../wm/wm-wam-quantization-reading-guide/papers/20-worldarena-2/README.md)、[WorldScore](../../wm/wm-wam-quantization-reading-guide/papers/21-worldscore/README.md)、[Physics-IQ](../../wm/wm-wam-quantization-reading-guide/papers/22-physics-iq/README.md)；mixed-bit companion 为 [24 Where Bits Matter](../../wm/wm-wam-quantization-reading-guide/papers/24-where-bits-matter/README.md)。

[返回主 Reading Guide](../../vla/reading-guide/README.md) · [原 simulation evaluation 库](../../vla/sim-eval-vla-reading-guide/README.md) · [原 control/world-model 方向](../../vla/vla-ideas-reading-guide/03-control-distillation-and-world-models/README.md)。本库编号独立，不改变主库 24 篇 core 的含义。
