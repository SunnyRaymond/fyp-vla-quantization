...
| 已有工作 | 已覆盖部分 | 尚不能由它证明 |
|---|---|---|
| [QuantWM](../../wm/wm-wam-quantization-reading-guide/papers/03-quantwm-STAR/README.md) | DINO-WM PTQ、granularity、encoder/predictor sensitivity、planning loss 与 success | 所有 JEPA/WAM 的普适规律；真实端到端 kernel 收益 |
| [Where Bits Matter](../../wm/wm-wam-quantization-reading-guide/papers/24-where-bits-matter/README.md) | paired mixed-bit、模块分配、planner budget | 多任务多平台普适最优；packed INT4 部署 |
...
| [SANA-WM](../../wm/wm-wam-quantization-reading-guide/papers/16-sana-wm/README.md) | FP8/NVFP4 video WM deployment、camera-conditioned generation | robot manipulation 闭环 success |
| [Matrix-Game 3.0](../../wm/wm-wam-quantization-reading-guide/papers/17-matrix-game-3/README.md) | INT8 路线与 distillation/decoder 优化 | 低比特独立贡献或跨 embodiment robot control |
