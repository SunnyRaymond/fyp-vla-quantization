...
建议先快速看本地 [LLM.int8 / bitsandbytes note](../013-llm-int8-bitsandbytes/README.md)，再读本篇，最后进入 [SmoothQuant](../017-smoothquant/README.md)。三篇分别代表 mixed-precision outlier routing、outlier suppression、以及 large-scale activation-to-weight smoothing。
