...
> **Reading-list role**: Critical companion to [TurboQuant](../025-turboquant/README.md) - the main citable source for the RaBitQ baseline dispute  
...
> **Foundational reading**: [original RaBitQ + multi-bit extension](../027-rabitq/README.md)  
...
5. Return to [TurboQuant final PDF](../025-turboquant/paper-iclr-2026-final.pdf), pp. 9-10 and 15.
