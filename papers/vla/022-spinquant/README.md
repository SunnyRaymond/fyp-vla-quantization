...
> **Recommended effort**: Deep read；先完成 [QuaRot 20-minute bridge](../023-quarot/README.md#20-minute-bridge-route-for-your-current-spinquant-reading)，再看 manifold optimization
...
- [QuaRot](../023-quarot/README.md)：fixed/randomized Hadamard rotation predecessor；先区分其 rotation construction 与默认 GPTQ calibration，再理解 SpinQuant 为什么学习 $R_1,R_2$。
