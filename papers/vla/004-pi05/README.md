...
- **读前知识**：[π₀](../002-pi0/README.md)、hierarchical policy、task decomposition、[FAST action tokenization](../003-fast/README.md)、flow matching、domain generalization、co-training 与 ablation statistics。
...
1. 先复习 [π₀ flow action expert](../002-pi0/README.md) 与 [FAST tokenization](../003-fast/README.md)。
