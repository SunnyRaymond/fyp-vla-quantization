...
[独立阅读库](../../wam/wm-wam-quantization-reading-guide/README.md)：24 份本地 PDF 与中文导读，覆盖 LeWorldModel / DINO-WM / V-JEPA、直接 quantization prior art、开源 WAM 和 benchmark 地图；不加入本主库 core count。
