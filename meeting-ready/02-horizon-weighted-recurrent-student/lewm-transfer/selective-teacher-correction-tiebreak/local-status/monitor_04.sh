...
printf '\n--- job log tail ---\n'
tail -n 35 /scratch/users/ntu/yguo017/dino-wm-wall/meeting-ready/02-horizon-weighted-recurrent-student/lewm-transfer/selective-teacher-correction-tiebreak/artifacts/25273781.pbs101/job.log 2>&1
