...
def main() -> int:
    ...
    try:
        if freeze.get("schema") != "dino-wm-shared-prefix-cache.pusht-transfer-freeze":
            add(errors, "freeze", "unexpected schema")
        expected_schema = "dino-wm-shared-prefix-cache.pusht-transfer-results"
        ...
        for index, row in enumerate(rows, 1):
            ...
            validate_trace(
                ...
                n_evals=len(expected_observations),
