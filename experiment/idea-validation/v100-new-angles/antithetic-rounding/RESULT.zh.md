...
- [冻结协议](../../../../idea/v100-new-angles/antithetic-rounding/IDEA_AND_PROTOCOL.zh.md)、[GPU原始小汇总](artifacts/64733/summary.json)、[独立复算](artifacts/64734/verification.json)。Scheduler记录位于campaign `scheduler/64733`、`scheduler/64734`。
