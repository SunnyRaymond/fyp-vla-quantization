...
[PTQD](https://arxiv.org/abs/2305.10657) 使“量化误差的相关性可能跨多步传播”成为已知背景；本候选不做 diffusion denoising、时间 schedule、correction 或 mixed precision。Antithetic 的 [冻结协议](../../../../idea/v100-new-angles/antithetic-rounding/IDEA_AND_PROTOCOL.zh.md) 是最接近的 campaign prior，但其 coupling 发生在 weight members；Persistence 的 [冻结协议](../rounding-persistence/PROTOCOL.zh.md) 是时间 coupling。Novelty 仍只可写 `unverified`，需要后续更专门的 activation spatial-correlation 检索才能升级。
