...
- 本地 source 根：`reproduction/dino-wm-wall/source/`
...
- `reproduction/dino-wm-wall/README.md`：source/checkpoint/runtime与旧运行边界。
- `reproduction/dino-wm-wall/artifacts/16170841.pbs101/checkpoint-config-original.yaml`：frameskip=5、predictor depth=6。
