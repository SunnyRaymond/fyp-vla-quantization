...
来源：`reproduction/dino-wm-wall/artifacts/16170841.pbs101/planning_times.jsonl`，7个完整CEM记录；同目录`stopped_summary.json`与`qstat_after_stop.txt`。旧运行FP32、50cases、H5、300candidates、top30、10CEM iterations、单A100。
