...
- [独立verification](artifacts/64834/verification.json)、[GPU summary](artifacts/64833/summary.json)、[GPU engineering](artifacts/64833/engineering.json)、[冻结协议](PROTOCOL.zh.md)、[input freeze](INPUT_FREEZE.zh.md)。
