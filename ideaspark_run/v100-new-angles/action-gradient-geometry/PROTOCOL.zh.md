...
2026-09-13，未采集新输出。裁剪pipeline：primary prior、C02受控诊断、冻结gate与独立审查。旧prior brief位于 `ideaspark_run/world-model-quantization/experiments/dino-wm-wall/action-gradient-geometry/IDEA_PRIOR_GATE.zh.md`，不移动或覆盖。
