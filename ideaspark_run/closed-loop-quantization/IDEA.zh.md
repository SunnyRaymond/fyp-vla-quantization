...
**2026-09-12 实验后更新：本页保留原 FRT 方案；其 CCDS Stage B 已判 mechanism_no_go。后续候选改为 [Paired-Rollout Recovery](<D:/Downloads/Final Year Project/ideaspark_run/closed-loop-quantization/revisions/paired-rollout-recovery/IDEA.zh.md>)，不继承旧结果支持。
